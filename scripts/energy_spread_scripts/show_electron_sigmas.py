...
if __name__=='__main__':
    syned_obj = load_from_json_file("ESRF_ID06_EBS_CPMU18_1.json")
    e = syned_obj.get_electron_beam()
    (sigma_x, sig_div_x, sigma_y, sig_div_y) = e.get_sigmas_all()
    print("sigma_x = ", 1e6 * sigma_x)
    print("sig_div_x = ", 1e6 * sig_div_x)
    print("sigma_y = ", 1e6 * sigma_y)
    print("sig_div_y = ", 1e6 * sig_div_y)
