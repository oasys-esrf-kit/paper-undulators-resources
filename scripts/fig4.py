...
def plot_backpropagated(figfile=""):
    ...
    # Spread7, Fwhm7, Sd7, Qs7 = wofry_results_backpropagated(harmonic_number=7, do_plot=0)
...
if __name__ == "__main__":
    ...
    plot_farfield(figfile="angular_width_vs_spread.pdf")

    # plot_backpropagated(figfile="") #angular_width_vs_spread_backpropagated.pdf")
