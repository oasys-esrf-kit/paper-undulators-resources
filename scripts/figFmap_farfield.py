...
if __name__ == "__main__":
    ...
    plot_image(Mfwhm_a.T,  Shift, Spread1, title="FWHM",
               ytitle=r'electron energy spread $\delta_\mathcal{E}$', xtitle="shift from resonance [eV]",
               aspect='auto', figsize=(11,9), show=0)
    plt.savefig("FdivFWHM.png")
    print("File written to disk: FdivFWHM.png")

    plot_image(Mstdev_a.T, Shift, Spread1, title="r.m.s.",
               ytitle=r'electron energy spread $\delta_\mathcal{E}$', xtitle="shift from resonance [eV]",
               aspect='auto', figsize=(11,9),  show=0)
    plt.savefig("FdivSD.png")
    print("File written to disk: FdivSD.png")
